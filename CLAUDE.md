...
Rementum sends no article text to any AI provider: `local-summary.ts` derives the routing summary
and bodies are stored as submitted. LLM compaction existed until migration 0024 and was removed
