...
Add `https://YOUR_HOST/mcp` as a remote Streamable HTTP MCP server and complete OAuth. Rementum
marks read tools with `readOnlyHint`; keep approval enabled for write tools.
