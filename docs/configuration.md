...
one-sentence summary of at most 300 characters, and a Markdown body of at most 1,500 characters.
The compact body must keep wiki-style `[[slug]]` links so articles stay reachable from each other.
A successful job overwrites the same encrypted version, removing the submitted body. Jobs retry after
