CREATE TABLE IF NOT EXISTS invitations (
  ...
  brain_role brain_role NOT NULL,
...
USING (owl_is_brain_owner(brain_id))
WITH CHECK (owl_is_brain_owner(brain_id));
...
GRANT SELECT, INSERT, UPDATE, DELETE ON invitations TO owl_app;
